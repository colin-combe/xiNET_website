...
<html lang="en">
    <head>
		<?php $pageName = "Figure 8";include("head.php");?>
...
-->
		...
		<script type="text/javascript">
				...
				d3.text('./data/PP2A.csv', "text/csv", function(text) {
					xlv.readCSV(text);
					document.getElementById('annotationsSelect').value = "SuperFamily";
					initSlider();				
					changeAnnotations();
				});				
