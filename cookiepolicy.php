...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div class="container">
                <h1 class="page-header">Cookies Policy</h1>
                ...
                <p>Cookies are small pieces of text sent by your web browser by a website
                    you visit. A cookie file is stored in your web browser and allows
                    the Service or a third-party to recognize you and make your next visit
                ...
                <ul>
                    <li>
                        ...
                        <p>We use both session and persistent cookies on the Service and
                            we use different types of cookies to run the Service:</p>

                        <p>Essential cookies. We may use essential cookies to authenticate
                ...
                <p>If you'd like to delete cookies or instruct your web browser to delete
                    or refuse cookies, please visit the help pages of your web browser.</p>
                ...
                <p>Please note, however, that if you delete cookies or refuse to accept them,
                    ...
                    not be able to store your preferences, and some of our pages might
                ...
                <ul>
                    ...
                    <li>
                        <p>For the Internet Explorer web browser, please visit this page
                            from Microsoft:
                    ...
                    <li>
                        <p>For the Safari web browser, please visit this page from Apple:
                            <a href="https://support.apple.com/kb/Ph31411?locale=en_US">https://support.apple.com/kb/Ph31411?locale=en_US</a></p>
                    </li>
                    <li>
                        <p>For any other web browser, please visit your web browser's official
                            web pages.</p>
                    </li>
                </ul>
