					...
					<div class="accordionContent" >
						<div style="margin-left: 1em; line-height: 1.7em;">
							...
							<ul>
								...
								<li>
								CSV files must currently be accompanied by a FASTA file (todo - use accessions)
								</li>
							</ul>
							<br/>
							<p>CSV Example:
							...
							<p>MzIdentML Example (generated by <a href="http://patternlabforproteomics.org/sim-xl/" target="_blank">SIM-XL<a/>):
								<a href="examples/SIM-XL_example.mzid" target="_blank">SIM_XL example</a>
							<p>
						</div>
