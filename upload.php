...
<hr class="wideDivider">
				...
				<ul>
					<li>
					<strong>Only the peptide identifications file is required</strong>, but without uploading peak lists you won't be able to inspect the supporting spectra using
