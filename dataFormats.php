    ...
    <body>
        ...
        <div id="main">
            <div class="container">
                ...
                <tr><td>PepPos1</td><td>Yes</td><td>Position of peptide 1 in protein 1 (1-based). Ambiguous results are represented by listing the alternative positions separated by semi-colons</td><td>-</td><td>10; 30</td></tr>
                <tr><td>PepPos2</td><td>Yes</td><td>Position of peptide 2 in protein 2 (1-based). Ambiguous results are represented by listing the alternative positions separated by semi-colons.</td><td>-</td><td>20</td></tr>
                ...
                *required if there are multiple alternative explanations for the same spectrum.</br>
                ...
                <h1 class="page-header accordionHead">
                <i class="fa fa-plus-square" aria-hidden="true"></i> Additional optional csv column headings
                </h1>
                <div class="accordionContent" style="display: none;" id="csv">
                <table class="myTable" id="csvTable">
                <thead>
                ...
                <!-- <tr><td>&nbsp;</td><td></td><td></td><td></td><td></td></tr>
                <tr><td>Meta1, etc</td><td>No</td><td>meta</td><td>-</td><td>meta</td></tr> -->
